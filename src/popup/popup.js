...
async function grantPermission() {
    ...
    let permission_url = "https://cts.strath.ac.uk/Scientia/live2627sws/default.aspx";
    let perm = {
...
async function contentLoaded() {
    ...
    let url = tab.url;
    tabId = tab.id;
    if (/^https?:\/\/cts.strath.ac.uk\/Scientia\/live2627sws\/showtimetable.aspx/.test(url)) {
...
async function fetchCourseList() {
    ...
    let url = "https://cts.strath.ac.uk/Scientia/live2627sws/default.aspx";
    ...
    doc = await fetch("https://cts.strath.ac.uk/Scientia/live2627sws/default.aspx", {
        "credentials": "include",
        "headers": {
            "Content-Type": "application/x-www-form-urlencoded",
        },
        "referrer": "https://cts.strath.ac.uk/Scientia/live2627sws/default.aspx",
...
async function openTimetable() {
    ...
    resp = await fetch("https://cts.strath.ac.uk/Scientia/live2627sws/default.aspx", {
        "credentials": "include",
        "headers": {
            "Content-Type": "application/x-www-form-urlencoded",
        },
...
&bGetTimetable=View+Timetable`,
    ...
    await browser.tabs.create({
        url: "https://cts.strath.ac.uk/Scientia/live2627sws/showtimetable.aspx",
        active: true,
    });
